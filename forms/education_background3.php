			  ...
			  <!-- <div class="top_link"><a href="login.php"><b>Login here</b></a></div> -->
                ...
                <div class="contact">
                    <form action="process-signup.php"  method="post" id="signup" name="form" novalidate>
                        ...
                        <input type="textarea" id="name" name="textarea" placeholder="university/college: eg UDSM(University Of Dar es salam)" onclick="resetBtn()">
                        <input type="text" id="date" name="date" placeholder="year accomplished: eg 2023" onclick="resetBtn()">
                        <input type="text" id="name" name="name" placeholder="award: eg (BECO) Bachelor Engineering of computer" onclick="resetBtn()">
