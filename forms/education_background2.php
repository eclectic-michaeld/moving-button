			  ...
			  <!-- <div class="top_link"><a href="login.php"><b>Login here</b></a></div> -->
                ...
                <div class="contact">
                    <form action="process-signup.php"  method="post" id="signup" name="form" novalidate>
                        ...
                        <input type="text" id="name" name="name" placeholder="highschool name" onclick="resetBtn()">
                        <input type="text" id="date" name="name" placeholder="year accomplished: eg 2019" onclick="resetBtn()">
                        <input type="text" id="name" name="name" placeholder="award: eg ACSE" onclick="resetBtn()">
