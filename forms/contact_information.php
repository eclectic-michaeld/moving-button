			  ...
			  <!-- <div class="top_link"><a href="login.php"><b>Login here</b></a></div> -->
                ...
                <div class="contact">
                    <form action="process-signup.php"  method="post" id="signup" name="form" novalidate>
                        ...
                        <input type="text" id="name" name="name" placeholder="Email" onclick="resetBtn()">
                        <input type="text" id="name" name="name" placeholder="Phone" onclick="resetBtn()">
                        <input type="text" id="name" name="name" placeholder="Adress: eg Kinondoni-Dar ae salaam" onclick="resetBtn()">
